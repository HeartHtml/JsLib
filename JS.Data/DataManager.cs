...
namespace JS.Data
{
    ...
    public static class DataManager
    {
        ...
        /// <param name="procedureName">Stored procedure name.</param>
        /// <param name="parameters">Parameters in procedure.</param>
        /// <param name="returnResultSet">Determines whether to return the entire result set or the first table</param>
        /// <returns>Dataset containing results of stored procedure call.</returns>
        public static DataSet ExecuteProcedure(string connectionString, string procedureName, IEnumerable<SqlParameter> parameters, bool returnResultSet = false)
        {
            DataSet dataSet = new DataSet { Locale = CultureInfo.CurrentCulture, EnforceConstraints = false };
